...
public class AmazonApiSearchRequestBuilder implements AmazonApiRequestBuilder {
	private AmazonApiRequest builtRequest;
	
	public class AmazonApiSearchRequestReady extends AmazonApiRequestReady {
	...
	public AmazonApiSearchRequestBuilder() {
		builtRequest = new AmazonApiRequest();
		initialise();
		AmazonApiRequestBuilderHelper.addCommonParams(builtRequest);
	}
	
	public static AmazonApiSearchRequestBuilder search() {
		return new AmazonApiSearchRequestBuilder();
	}
